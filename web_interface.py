...
def main():
    ...
    with col1:
        ...
        if uploaded_video is not None:
            ...
            if st.button("🚀 Process Video", type="primary"):
                processing_caption = "Video is processing, and a new window will open for live detection..." if enable_live_window else "Video is processing..."
    ...
    with col2:
        ...
        **Model Settings:**
        ...
        - Confidence: 0.01 for testing
        - Siren Filtering: Requires clear siren audio
        - Motion Analysis: Needs multiple frames per track
        - Live Window: Run 'sudo apt-get install libgtk-3-dev', 'export DISPLAY=:0'
        """)
